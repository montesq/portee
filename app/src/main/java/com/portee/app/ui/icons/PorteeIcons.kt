package com.portee.app.ui.icons
...
// Phosphor icon paths, copied verbatim from the Nocturne design handoff (256x256 viewBox).
private fun phosphorIcon(name: String, pathData: String): ImageVector =
    ImageVector.Builder(
        name = name,
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
